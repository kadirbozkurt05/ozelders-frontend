...
import { Select, SelectContent, SelectTrigger, SelectItem } from "./select";
        ...
        Dropdown: (props) => {
          ...
          if (props.name === "months") {
            const selectedItems = Array.from({ length: 12 }, (_, i) => ({
              value: i.toString(),
              label: format(setMonth(new Date(), i), "MMMM", { locale: tr }), // Pass the tr locale here
            }));
            ...
            return (
              ...
              >
                <SelectTrigger>{format(currentMonth, "MMM", { locale: tr })}</SelectTrigger> {/* Pass the tr locale here */}
                <SelectContent>
